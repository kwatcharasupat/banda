...
from audiomentations.core.composition import Compose as _Compose, SomeOf as _SomeOf

from banda.data.augmentation.base import AugmentationConfig, AugmentationRegistry, BaseRegisteredAugmentation
...
class Compose(_Compose):
    ...
    @staticmethod
    def _build_augmentation(config: CompositionConfig) -> List[BaseRegisteredAugmentation]:
